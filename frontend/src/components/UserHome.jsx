  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-primary text-primary">
      <div className="flex items-center justify-center flex-col gap-12 mb-20">
        <Navbar />
        <div className='w-full text-secondary flex items-center justify-start px-10'>
          <h1 className="text-lg font-light">Welcome Back {" "}
        ...
        {books && books.length > 0 ? (
          <div className='w-full px-10'>
            <h2 className="text-2xl text-secondary font-normal mb-4">You Might Like</h2>
